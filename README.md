...
prince = {
    ...
    "tools"      : ["Python", "SQL", "Power BI", "DAX", "Excel", "Tableau"],
...
**Tools:** Python (Pandas, Matplotlib, Seaborn) · SQL (PostgreSQL) · Power BI (DAX)
...
**Tools:** Python (Pandas, Matplotlib, Seaborn) · SQL (PostgreSQL) · Power BI (DAX) · Excel (source data)
