...
prince = {
    "name"       : "Prince Kumar",
    "role"       : "Data Analyst",
    "background" : "3 Years @ Wockhardt Pharmaceuticals — Key Account Management",
    "domain"     : "Pharma Commercial Analytics · Retail Profitability · Healthcare Operations",
    "tools"      : ["Python", "SQL", "MySQL", "Power BI", "DAX", "Excel"],
    "superpower" : "Turning messy business data into decisions that hold up under scrutiny 💡"
}
```
...
**Tools:** Python (Pandas, Matplotlib, Seaborn) · SQL (MySQL) · Power BI (DAX)

| Highlight | Finding |
|-----------|---------|
| 💰 Revenue Analyzed | ₹84.12M across 4 territories, 20 reps, 3 products |
...
**Tools:** Python (Pandas, Matplotlib, Seaborn) · SQL (MySQL) · Power BI (DAX) · Excel (source data)

| Highlight | Finding |
|-----------|---------|
| 💸 Loss Transactions | **48.98%** of 1,952 transactions are loss-making — $291.45K lost within $1.92M sales |
| 📦 Not a discounting problem | Only 2 of 1,952 transactions carry >10% discount (r ≈ -0.06 to profit). Loss transactions average $590 vs. $1,366 for profitable ones — the real driver is small-order cost-to-serve |
...
[![View Project](https://img.shields.io/badge/View%20Project-no--show--analysis-E74C3C?style=for-the-badge&logo=github&logoColor=white)](https://github.com/prince2310-97/Medical_appointment_No_Show_Analysis)
![Python](https://img.shields.io/badge/Python-3776AB?style=flat&logo=python&logoColor=white)
...
**Business impact:** Recommended prioritizing SMS budget toward longer-wait appointments (where the association is strongest), targeted engagement for 18–34-year-olds, and a review of high-no-show neighbourhoods — all framed as pilot hypotheses from a correlational analysis, not proven causal effects.
...
[![Resume](https://img.shields.io/badge/Resume-View%20My%20CV-4CAF50?style=for-the-badge&logo=github&logoColor=white)](https://drive.google.com/file/d/1x8UF3tDkqBX3mSEK57SRSrZ2PiQUgyq7/view?usp=drive_link)
